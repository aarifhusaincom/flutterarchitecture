...
class MaterialTheme {
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff532b20),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff926153),
      ...
      tertiaryFixed: Color(0xff926153),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff77493c),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryFixed: Color(0xffffffff),
      primaryFixedDim: Color(0xff4e214b),
      onPrimaryFixedVariant: Color(0xffffffff),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      brightness: Brightness.dark,
      primary: Color(0xffffcdf4),
      surfaceTint: Color(0xfff1b3e6),
      onPrimary: Color(0xff3f143d),
      ...
      tertiary: Color(0xffffd2c6),
      onTertiary: Color(0xff3f1b11),
      ...
      primaryFixed: Color(0xffffd7f5),
      onPrimaryFixed: Color(0xff260026),
      primaryFixedDim: Color(0xfff1b3e6),
      onPrimaryFixedVariant: Color(0xff52254f),
      secondaryFixed: Color(0xfff7daef),
      ...
      tertiaryFixedDim: Color(0xfff5b8a7),
      onTertiaryFixedVariant: Color(0xff532b20),
      surfaceDim: Color(0xff171216),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      onPrimaryContainer: Color(0xff1c001c),
      ...
      tertiaryContainer: Color(0xfff1b4a3),
      onTertiaryContainer: Color(0xff1d0300),
      ...
      primaryFixedDim: Color(0xfff1b3e6),
      onPrimaryFixedVariant: Color(0xff260026),
      secondaryFixed: Color(0xfff7daef),
